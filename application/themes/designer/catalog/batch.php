...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <div class="jumbotron">
                <h2>Trycatch Classes php training | <small>Codeigniter batch insert tutorial</small></h2>
                <p><a class="btn btn-primary btn-lg" href="http://TryCatchClasses.com/">Learn more</a> Author: <a href="https://www.facebook.com/TryCatchClasses/">by TryCatch Classes</a> </p>
            </div>
