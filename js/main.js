...
document.querySelectorAll(".product_life").forEach(
    (elm)=> {elm.addEventListener("change",choosedagnat);}
);

document.querySelectorAll(".season").forEach(
    (elm)=> {elm.addEventListener("change",choosedagnat);}
);
...
document.querySelectorAll(".product_type").forEach(
    (elm)=> {elm.addEventListener("change",choosedagnat);}
);

document.querySelectorAll(".categories").forEach(
    (elm)=> {elm.addEventListener("change",choosedagnat);}
);
...
function myFunction() {
    var checkBox = document.getElementById("product_type");
    var text = document.getElementById("toggle-equipment");
...
function Apparel() {
    var checkBox = document.getElementById("apparel");
    var text = document.getElementById("toggle-apparel");
    if (checkBox.checked == true){
      text.style.display = "block";
    } else {
       text.style.display = "none";
...
function Footwear() {
    var checkBox = document.getElementById("footwear");
    var text = document.getElementById("toggle-footwear");
    if (checkBox.checked == true){
      text.style.display = "block";
    } else {
       text.style.display = "none";
