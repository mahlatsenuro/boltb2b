...
function damaged() {
    ...
    var text = document.getElementById("toggle-damaged");
...
function shipmentNike() {
    var checkBox = document.getElementById("shipment_nike");
    ...
    if (checkBox.checked == true){
        shipment_nike.style.display = "flex";
        direct_shipment.style.display = "none";
    } else {
       text.style.display = "none";
    }
}
...
function undamaged() {
    var checkBox = document.getElementById("undamaged");
    var undamaged = document.getElementById("toggle-undamaged");
...
function missCartons() {
    var checkBox = document.getElementById("miss_cartons");
    var miss_cartons = document.getElementById("toggle-miss_cartons"); 
    var entire_shipment = document.getElementById("toggle-entire_shipment");
    var damaged = document.getElementById("toggle-damaged");
    var undamaged = document.getElementById("toggle-undamaged");
...
function entireShipment() {
    var checkBox = document.getElementById("entire_shipment");
    var entire_shipment = document.getElementById("toggle-entire_shipment");
    var damaged = document.getElementById("toggle-damaged");
    var undamaged = document.getElementById("toggle-undamaged");
    var miss_cartons = document.getElementById("toggle-miss_cartons"); 
